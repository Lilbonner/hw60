    ...
    return (
        <>
            <div>
                ...
                <div className='border-2 bg-blue-900 '>
                    {messages.map((message) => (
                        <div className='border-2 rounded-lg my-3 bg-gray-400 max-w-fit' key={message._id}>
                            <p>Author: {message.author}</p>
                            <div className='bg-blue-300 rounded-lg'>
                                <p>{message.message}</p>
                                <p className='grid justify-items-end'>{formatDateTime(message.datetime)}</p>
                            </div>
